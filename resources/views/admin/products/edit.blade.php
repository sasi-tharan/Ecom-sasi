                    ...
                    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="si_upc" class="form-control" value="{{ $product->si_upc }}" />
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="">Barcode / SKU</label>
                                <input type="text" name="barcode_sku" class="form-control" value="{{ $product->barcode_sku }}" />
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="department_id" id="department_id" class="form-control">
                                    ...
                                    @foreach ($departments as $department)
                                        <option value="{{ $department->id }}" data-title="{{ $department->department_title }}" {{ $product->department_id == $department->id ? 'selected' : '' }}>{{ $department->department_title }}</option>
                                    @endforeach
                                </select>
                                <input type="hidden" name="department_title" id="department_title" value="{{ $product->department_title }}">
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="group_id" id="group_id" class="form-control">
                                    ...
                                    @foreach ($groups as $group)
                                        <option value="{{ $group->id }}" data-title="{{ $group->group_title }}" {{ $product->group_id == $group->id ? 'selected' : '' }}>{{ $group->group_title }}</option>
                                    @endforeach
                                </select>
                                <input type="hidden" name="group_title" id="group_title" value="{{ $product->group_title }}">
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="sub_group_id" id="sub_group_id" class="form-control">
                                    ...
                                    @foreach ($subGroups as $subGroup)
                                        <option value="{{ $subGroup->id }}" data-title="{{ $subGroup->sub_group_title }}" {{ $product->sub_group_id == $subGroup->id ? 'selected' : '' }}>{{ $subGroup->sub_group_title }}</option>
                                    @endforeach
                                </select>
                                <input type="hidden" name="sub_group_title" id="sub_group_title" value="{{ $product->sub_group_title }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="">Pack Size</label>
                                <input type="text" name="packsize" class="form-control" value="{{ $product->packsize }}" />
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="case_price" class="form-control" value="{{ $product->case_price }}" />
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="">RSP</label>
                                <input type="text" name="rsp" class="form-control" value="{{ $product->rsp }}" />
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="">VAT</label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="">POR</label>
                                <input type="text" name="por" class="form-control" value="{{ $product->por }}" />
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="">1 BCQTY</label>
                                <input type="text" name="bcqty_1" class="form-control" value="{{ $product->bcqty_1 }}" />
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="por_1" class="form-control" value="{{ $product->por_1 }}" />
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="">2 BCQTY</label>
                                <input type="text" name="bcqty_2" class="form-control" value="{{ $product->bcqty_2 }}" />
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="">2 BCP</label>
                                <input type="text" name="bcp_2" class="form-control" value="{{ $product->bcp_2 }}" />
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="">POR 2</label>
                                <input type="text" name="por_2" class="form-control" value="{{ $product->por_2 }}" />
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="">3 BCQTY</label>
                                <input type="text" name="bcqty_3" class="form-control" value="{{ $product->bcqty_3 }}" />
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="">3 BCP</label>
                                <input type="text" name="bcp_3" class="form-control" value="{{ $product->bcp_3 }}" />
                            </div>
                            <div class="col-md-4 mb-3">
